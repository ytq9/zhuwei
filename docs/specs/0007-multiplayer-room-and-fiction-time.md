...
所有澄清、反应、角色选择和升级都绑定唯一控制主体与 Visibility Policy。只有该主体能看到窗口是否存在、选项、时点和响应结果。
...
桌外内容边界、成员管理和行为纠纷属于房间协调，不伪装为角色事件。
...
8. （已删除：内容安全暂停于 2026-09-19 按 ADR 0032 移出产品。）
