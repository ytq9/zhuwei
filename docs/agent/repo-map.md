...
| [v2/world-interactions.ts](../../app/_runtime/lib/rules/v2/world-interactions.ts) 与 `world-interaction-*.ts`† | vNext 交互计划、分支、冻结随机、原子束与有限机械效果；条件、成本、危害、目标、前缀、随机各自成文件；隐蔽检定的在场候选、被动察觉与察觉者比较在 [concealment.ts](../../app/_runtime/lib/rules/v2/concealment.ts)（ADR 0059） |
