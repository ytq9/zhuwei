...
| [v2/world-interactions.ts](../../app/_runtime/lib/rules/v2/world-interactions.ts) 与 `world-interaction-*.ts`† | vNext 交互计划、分支、冻结随机、原子束与有限机械效果；条件、成本、危害、目标、前缀、随机各自成文件；隐蔽检定的在场候选、被动察觉与察觉者比较在 [concealment.ts](../../app/_runtime/lib/rules/v2/concealment.ts)（ADR 0059），察觉者的当场反应记录与结算在 [npc-reactions.ts](../../app/_runtime/lib/rules/v2/npc-reactions.ts)，反应调用的本人视图请求在 [kp/vnext/npc-reaction.ts](../../app/_runtime/lib/kp/vnext/npc-reaction.ts)（ADR 0060） |
...
| 模型传输 | [provider.ts](../../app/_runtime/lib/kp/provider.ts)、[deepseek.ts](../../app/_runtime/lib/kp/deepseek.ts)、[deepseek-strict-tool.ts](../../app/_runtime/lib/kp/deepseek-strict-tool.ts)、[openai.ts](../../app/_runtime/lib/kp/openai.ts)；[model-request.ts](../../app/_runtime/lib/kp/model-request.ts) 统一发送与持久化请求的序列化（模型绑定见 [ADR 0040](../adr/0040-gpt-6-luna-provider-and-room-binding.md)） + [model-call-scope.ts](../../app/_runtime/lib/kp/vnext/model-call-scope.ts)† 每请求调用上限、[invocation/assemble.ts](../../app/_runtime/lib/kp/vnext/invocation/assemble.ts) 组装与预算门 |
