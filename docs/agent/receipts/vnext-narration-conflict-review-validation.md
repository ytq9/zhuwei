...
round50实际10调用、20,415输入/1,978输出、¥0.0291299；round51实际1调用、2,314输入/245输出、¥0.0045735。全部开发费用，按round49本轮重读官方空闲价计算，非账单核对。见[round50原始判断](../fixtures/vnext-round50-live-evidence.json)、[round51原始判断及最终离线拒绝](../fixtures/vnext-round51-live-evidence.json)。
