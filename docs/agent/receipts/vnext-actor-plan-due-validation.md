...
20文件逐项核对复制基线后串行集成，0冲突，原文件已备份。[集成清单](../fixtures/vnext-actor-plan-due-integration.json)包含原/新 SHA；manifest SHA `4c20a73d3a5e5e0816c0733591b0799dec9b67bf39581e26e1e5c7901673c848`。直接消费者为 Rules due/ActorPlan/Claims/事件/投影、Room提交/恢复/telemetry/server、KP strict决定/workflow和共享调用scope，玩家parser v27保持。
