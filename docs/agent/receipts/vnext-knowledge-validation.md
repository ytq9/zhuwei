...
两批合计 4 调用、41,554 输入/6,228 输出，空闲标价 ¥0.0892434，全部计开发。见[round21/22 完整记录](vnext-round22-validation.md)与[脱敏 evidence](../fixtures/vnext-round22-live-evidence.json)。
