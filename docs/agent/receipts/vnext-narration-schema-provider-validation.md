...
- [Provider集成清单](../fixtures/vnext-narration-provider-error-integration.json)。
- [schema集成清单](../fixtures/vnext-narration-review-schema-integration.json)，review v11/policy v9。
