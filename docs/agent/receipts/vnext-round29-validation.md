...
源码清单为 [round29 manifest](../fixtures/vnext-round29-source-manifest.json)，hash `b0236e36cd76ae479805407d3738101fd7fdc843281e106fe494c3817c2a80e4`。调用完成后、修复前核对 301 个文件均未变化；当前修复后源码不再等于这份历史清单。预算、usage、原拒绝和 replay 摘要见 [脱敏证据](../fixtures/vnext-round29-live-evidence.json)。本地 server/capture 已停止，收束时复核 4320/4321 无监听。
