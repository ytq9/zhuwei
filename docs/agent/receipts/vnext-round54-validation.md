...
详细证据及 SHA256：[vnext-round54-live-evidence.json](../fixtures/vnext-round54-live-evidence.json)、`/tmp/redacted/zhuwei-round54-closeout/artifact-hashes.json`；原始私密 captures 保留在 `/tmp/zhuwei-vnext-round54-private/`，不复制进仓库。
