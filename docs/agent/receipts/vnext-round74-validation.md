...
[机器证据](../fixtures/vnext-round74-live-evidence.json)。原始 capture、冻结上下文、journal、权威快照与原稿保存在 `/tmp/zhuwei-round74-npc-preparation/evidence`；公开文件不含 Cookie、密码、私有上下文正文或模型推理。
