...
[脱敏证据](../fixtures/vnext-round67-live-evidence.json)；受限原稿、冻结请求、journal、状态及日志在 `/tmp/zhuwei-round67-npc-preparation/evidence/`。extract/replay/source-end 均 exit 0；capture24080/game24088 按身份 SIGTERM，进程及4320/4321端口消失，detached 退出码未知。未部署、push 或修改生产数据；完整 Goal 保持 active。
