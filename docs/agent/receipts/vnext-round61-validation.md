...
证据：[脱敏JSON](../fixtures/vnext-round61-live-evidence.json)、[本次实现与定向验证](vnext-passive-time-validation.md)。本批证明被动等待及既有NPC到期链可真实执行，不能证明后续观察、复杂Activity、新NPC计划、多人20+或统计稳定性通过。完整Goal继续active；未部署、push、commit或退役数据。
