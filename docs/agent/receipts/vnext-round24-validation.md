...
[调用前源码清单](../fixtures/vnext-round24-source-manifest.json)记录289文件，UTC `2026-09-05T22:42:27.477743+00:00`，manifest hash `ffb31229a14c052b1dbddd7ef9edce984a18e75703c7f808907edf1b99dc7d00`；调用结束逐文件核验无变化。Workflow仍为 `sha256:1835a36cc2eb7fd721c535f9e3d72b27e81b8b8473566402a4d1de5d28a0b672`。完整数值和结果见[脱敏证据](../fixtures/vnext-round24-live-evidence.json)；捕获文件hash不是HTTP wire hash。
