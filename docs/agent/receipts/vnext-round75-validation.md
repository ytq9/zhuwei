...
[机器证据](../fixtures/vnext-round75-live-evidence.json)。原始 capture、冻结上下文、journal 与权威快照保存在 `/tmp/zhuwei-round75-npc-preparation/evidence`；公开文件不含 Cookie、密码、私有上下文正文或模型推理。
