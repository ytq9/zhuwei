...
服务 90473、捕获 90439 受控 TERM，均退出 143；extract/source-end/replay 全部退出 0，端口 4320/4321 已空。[完整脱敏证据](../fixtures/vnext-round57-live-evidence.json)，私有原始材料位于 `/tmp/zhuwei-vnext-round57-*`。round56 的失败结论保留。
