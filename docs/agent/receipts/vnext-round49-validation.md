...
离线extract、完整replay、费用与源码核对均exit0（工具chunk 34d59c、3b5f78、8fea91、bf0a31）。脱敏证据见[vnext-round49-live-evidence.json](../fixtures/vnext-round49-live-evidence.json)。原请求经原Room delivery构造器从SQLite导出，generation请求与capture完整深等；没有重新project、重提案、API调用或发布。私有冻结请求/tmp/zhuwei-round49-frozen-request.json，0600，SHA 10e1c04f4d8819f3f0d09ca9b06fa72f2120a8072c8b2392e489405097523549。
