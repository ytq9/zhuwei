...
证据：[脱敏JSON](../fixtures/vnext-round60-live-evidence.json)；私有原稿、冻结请求、响应、journal、SQLite前态、表格和源码清单位于 `/tmp/zhuwei-vnext-round60-*`，权限0700/0600。extract/source-end/replay退出0；closeout首次错误地断言两种审核都应无表，离线修正为零组省字段/非零组完整后退出0，未改变产品/模型证据、未新增API。
