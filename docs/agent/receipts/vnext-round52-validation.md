...
[脱敏机器证据](../fixtures/vnext-round52-live-evidence.json)。完整本地封存 `/tmp/redacted/zhuwei-round52-closeout/`；Node 原 runtime.replay exit 0。source manifest SHA256 为 `c3388c9aae11b46f0352be944a6fb98e7dce725a15f4748d4d6b8b06036356e2`。
