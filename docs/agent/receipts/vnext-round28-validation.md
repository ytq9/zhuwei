...
[源码清单](../fixtures/vnext-round28-source-manifest.json)299文件，UTC`2026-09-06T04:29:17.675165+00:00`，hash`21f8180bed31ae166b0fab3a85555805b4d79d991c25954bdf3f751b91115862`；请求期间源码不变。Workflow/schema/parser/runtime和脱敏usage见[证据JSON](../fixtures/vnext-round28-live-evidence.json)。调用前重读官方价格，周日为空闲时段；费用是usage乘官方标价，非扣款凭证。
