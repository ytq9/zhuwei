...
export const LIVE_KP_EVAL_MODEL = "deepseek-v4-flash";
export const LIVE_KP_EVAL_PROVIDER = "deepseek";
...
export async function runLiveKpEvaluation(options) {
  ...
  if (!productionTarget && options.allowNonProductionTarget !== true) {
    throw new TypeError("Only the production Worker can produce a live KP model evaluation report.");
  }
  ...
  if (
    ...
    throw new TypeError("The evaluation room is not an active authoritative-v2 room with the pinned V3 KP model.");
  }
