...
// Full current-world material with the module's opening items/knowledge can
// exceed 48k units. This artifact guard stays below the independent 96k
// provider admission limit; call, token and cost reservations are unchanged.
export const ROOM_STORY_CONTEXT_MAX_UNITS = 64_000;
...
export const ROOM_STORY_BUDGET_REF = deepFreeze({ id: "zhuwei.room-story-budget", version: "1",
  hash: canonicalHash({ transport: ROOM_STORY_TRANSPORT, contextMaxUnits: ROOM_STORY_CONTEXT_MAX_UNITS,
    inputCounter: "conservative-v1", limits }) as StoryHash });
