...
const CAUSAL_ACTION_LANGUAGE_REGISTRATION = Object.freeze({
  ...
  languageVersion: "causal-action-program-v3.1",
...
const PRIMITIVE_ARGUMENT_KEYS: Readonly<Record<CausalPrimitive, readonly string[]>> = Object.freeze({
  ...
  refuseInWorld: Object.freeze(["goal", "reason", "alternatives", "basisRefs", "fictionTime"]),
  ...
  assessCausalStage: Object.freeze(["goal", "method", "intendedOutcome", "risk", "basisRefs"]),
  joinCausalBranches: Object.freeze(["intendedOutcome", "risk", "alternatives", "fictionTime"]),
});
...
const PRIMITIVE_REQUIRED_ARGUMENT_KEYS: Readonly<Record<CausalPrimitive, readonly string[]>> = Object.freeze({
  ...
  inspectFiction: Object.freeze(["goal", "method", "focus", "desiredInformation"]),
  exchangeWithNpc: Object.freeze(["goal", "method", "utterance", "desiredResponse"]),
  assessOrdinaryAction: Object.freeze(["goal", "method", "intendedOutcome", "risk"]),
  assessHighRiskAction: Object.freeze(["goal", "method", "intendedOutcome", "risk", "stakes"]),
  refuseInWorld: Object.freeze(["goal", "reason", "alternatives"]),
  materializeOpenFact: Object.freeze(["goal", "method", "proposedFact", "basisRefs"]),
  resolveCombatIntent: Object.freeze(["goal", "method", "intendedOutcome", "combatApproach"]),
  resolveEnvironmentalStunt: Object.freeze(["goal", "method", "featureDescription", "intendedOutcome"]),
  assessCausalStage: Object.freeze(["goal", "method", "intendedOutcome"]),
  joinCausalBranches: Object.freeze(["intendedOutcome"]),
});
