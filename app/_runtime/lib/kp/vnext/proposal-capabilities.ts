...
export const VNEXT_PROPOSAL_CAPABILITIES = deepFreeze([
  ...
  { id: "social", proposalKind: "social", description: "与已知 NPC 当面对话：依据该 NPC 自身冻结知识作出回应或沉默、关系变化及 NPC 权限内承诺和债务；保留原玩家表达，承诺不提前执行物理效果。交谈本身消耗虚构时间，由decision.duration的档位冻结；需要等待、通行或休整的后续动作另提相应计划。", dependencies: [] },
