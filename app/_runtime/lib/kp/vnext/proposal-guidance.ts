...
export const VNEXT_PROPOSAL_GUIDANCE_POLICY = deepFreeze({
  version: "zhuwei.proposal-guidance/v34", selection: "flat-type-selection-with-exact-terminal-and-step-surface/v4",
