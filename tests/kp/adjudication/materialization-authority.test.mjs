import { soleStep, rebundle } from '../../support/fixtures/vnext-action-duration.mjs';
...
test("strict tool default sentinels reach the frozen template through decoding, lowering, Rules and replay", () => {
  ...
  const authored = decodeVNextStrictToolBundle({ decision: { kind: "directSuccess" }, steps: { authorAbility: [{
    source: { kind: "ability", observableState: "none", affordances: "none" }, outcomeBinding: "always" }] } });
