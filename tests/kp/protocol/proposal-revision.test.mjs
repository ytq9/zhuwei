...
import { decodedIndex, reordered } from '../../support/fixtures/vnext-wire-tables.mjs';
import { sentContext, sentInstructions, sentRevision, sentTurns } from '../../support/fixtures/vnext-request-layout.mjs';
