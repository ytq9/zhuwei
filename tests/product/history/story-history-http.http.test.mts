...
import { historyHttpAccount, historyHttpAuthority, historyHttpDb, historyHttpDraft, historyHttpPost,
  historyHttpSource, historyHttpWizard, httpRecord } from "../../support/fixtures/story-history-http";

// Run with tests/config/history-http.config.mjs. The real handlers use
...
beforeAll(async () => {
  expect(Object.keys(migrations).length, 'HTTP fixture must discover the repository migrations before registration').toBeGreaterThan(0);
