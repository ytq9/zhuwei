...
const BASE_INPUT = Object.freeze({
  ...
  profiles: Object.freeze({
    runtime: Object.freeze({ profileId: "runtime-srd51-2014-authoritative-v2" }),
    ruleset: Object.freeze({ profileId: "dnd5e-2014-srd5.1-authoritative-v2" }),
    eventSchema: Object.freeze({ profileId: "room-world-events-v2" }),
  }),
  model: Object.freeze({
    provider: "cloudflare-workers-ai",
    modelId: "@cf/meta/llama-3.3-70b-instruct-fp8-fast",
    revision: "workers-ai-catalog-2026-08-26",
    modelProfileVersion: "kp-model-profile-v2",
    promptPolicyVersion: "kp-prompt-policy-v2",
    schemaVersion: "kp-proposal-schema-v2",
    task: "proposal",
    attempt: 2,
