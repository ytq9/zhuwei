...
const SCENARIOS = [
  {
    ...
    covers: [
      {
        file: "tests/kp/adjudication/stage3.room.test.ts",
  ...
  },
  {
    ...
    covers: [
      {
        file: "tests/kp/protocol/proposal-schema.test.mjs",
  ...
  },
  {
    ...
    covers: [
      {
        file: "tests/kp/world/hazard-actor-death-fold.test.mjs",
  ...
  },
  {
    ...
    covers: [
      {
        file: "tests/kp/combat/ability-profile.test.mjs",
  ...
  },
  {
    ...
    covers: [
      {
        file: "tests/kp/narration/claims.test.mjs",
  ...
  },
  {
    ...
    covers: [
      {
        file: "tests/kp/knowledge/observer-projection.test.mjs",
